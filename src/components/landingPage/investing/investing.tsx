...
import HomeCarousel from "../tool/carousel";
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10">
              <div className="bg-blue-900 rounded-lg px-6 py-3 text-white shadow-lg">
                ...
                <p>Sort financial documents with precision using machine learning.</p>
              ...
              <div className="bg-white rounded-lg px-6 py-3 text-gray-700 shadow-lg">
                ...
                <p>Identify suspicious activity with tampering detection and validation.</p>
                <div className="flex space-x-5 py-5">
                  <p>Learn more</p>
                  <ArrowRightIcon className="w-5" />
                </div>
        ...
        <section className="container-fluid my-10">
          <div className="row">
            <div className="col-lg-6 pt-20">
              ...
              <div className="flex justify-between mt-6 sm:mt-10">
                <div className="col-sm-6">
                  <p className="font-bold text-4xl sm:text-6xl text-blue-800">15%</p>
                  <p className="text-sm sm:text-base">AI Prediction</p>
                </div>
                <div className="col-sm-6">
                  <p className="font-bold text-4xl sm:text-6xl text-blue-800">40%</p>
            ...
            <div className="col-lg-6">
              <img src="assets/images/landingPage/phone-chart.png" alt="" height={400} width={400} />
            </div>
            ...
            <div className="col-lg-6">
              <p className="text-lg font-medium">
                Leverage the combined power of IBM PREDICT.IF Finance and our proprietary AI models to swiftly analyse vast streams of news articles, alternative data sources, and traditional financial data. Unlock actionable insights at lightning speed, while
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="col-lg-6 space-y-7">
                ...
                <div className="bg-blue-800 px-4 py-14 ">
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <p className="font-bold pb-2 text-white">Secured abd Insured</p>
                ...
                <div className="bg-blue-800 px-4 py-14 ">
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <p className="font-bold pb-2 text-white">No trading fees</p>
                      <p className="leading-relaxed text-white">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
                      </p>
                    </div>
                ...
                <section className="container my-20 bg-[#e0e1e4] px-7 py-7">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch">
                        ...
                        <div className="w-full sm:w-1/2 relative flex-grow">
                            ...
                            />
                            <div className="absolute inset-0 bg-black opacity-100"></div> {/* Adjusted opacity */}
