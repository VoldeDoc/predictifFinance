...
const ForgetPwdOtpVerification = () => {
  const { ResendOtp, VerifyOtpForgetpwd } = UserAuthentication()
  ...
  const handleSubmit = async () => {
    ...
    try {
       await VerifyOtpForgetpwd({ email: email, otp: enteredOtp });
...
export default ForgetPwdOtpVerification;