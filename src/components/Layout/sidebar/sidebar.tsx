  ...
  ({ showNav, setShowNav }, ref) => {
    return (
      ...
      >
        ...
        <div
          className={` relative  w-full items-end mt-20 mb-[100%] mx-auto p-4  space-y-3 ${
            showNav ? "" : "hidden"
          }`}
        >
          {/* <div className="flex item-center justify-between"> */}
          {/* <div className="absolute w-[206px] h-[233px]  bg-[rgba(199,255,165,0.4)] box-border"></div> */}
        ...
        <ul className={`${showNav ? "" : "mx-auto"} mt-24 mb-10`}>
          <li>
            <NavLink
              to="/logout"
              className={`${
                showNav ? "ml-2 px-3" : "pl-2"
              } py-4 rounded-2xl text-center text-gray-500 px-5 cursor-pointer flex items-center gap-7 transition-colors ease-in-out duration-150 ${HOVER_STYLING}`}
            >
