...
function Footer() {
  return (
    <footer className="bg-[#001f80] text-white py-10">
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-4 gap-8 px-6 mt-32">
        ...
        <div className="col-span-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-400 bg-transparent block ps-10 p-2.5"
            />
          </div>
